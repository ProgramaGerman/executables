"""
Script para generar el archivo .spec de PyInstaller con configuración optimizada
"""
...
def create_spec_file():
    ...
    icon_path = os.path.join(project_dir, "icons", "codigo-qr.ico")
...
icon_path = r"{icon_path}" if r"{icon_path}" else None
...
'''
    ...
    spec_file_path = os.path.join(project_dir, "QR_Generator.spec")
    
    with open(spec_file_path, 'w', encoding='utf-8') as f:
        f.write(spec_content)
    
    print(f"✅ Archivo .spec creado: {spec_file_path}")
